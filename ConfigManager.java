...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Board.Title", "&8\u00bb &6&l\u26a1 Abilities \u26a1 &8\u00ab");
			config.addDefault("Board.Prefix.Text", "\u27a4 ");
			config.addDefault("Board.Prefix.SelectedColor", ChatColor.BLUE.getName());
			config.addDefault("Board.Prefix.NonSelectedColor", ChatColor.GRAY.getName());
			config.addDefault("Board.EmptySlot", "&8Slot {slot_number} &7- &8Empty");
			config.addDefault("Board.MiscSeparator", "&8\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac");
...
//			config.addDefault("Abilities.Water.PlantTether.DeathMessage", "{victim} was constricted by {attacker}'s {ability}");
			...
			config.addDefault("Properties.CreatorBroadcast.Enabled", true);
			config.addDefault("Properties.CreatorBroadcast.IntervalMinutes", 30);
			config.addDefault("Properties.CreatorBroadcast.Message", "Bending crafted with mastery \u2014 Created by Master!");
			...
			config.addDefault("Properties.BendingBoardAutoHideSeconds", 120);
