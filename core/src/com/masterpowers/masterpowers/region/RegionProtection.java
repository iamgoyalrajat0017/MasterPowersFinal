...
import com.masterpowers.masterpowers.hooks.RegionProtectionHook;
import com.masterpowers.masterpowers.util.BlockCacheElement;
...
public class RegionProtection {
    ...
    public static void startCleanCacheTask(double period) {
        Bukkit.getScheduler().runTaskTimer(MasterPowers.plugin, () -> {
