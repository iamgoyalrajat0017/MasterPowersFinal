...
import com.masterpowers.masterpowers.ability.SubAbility;
...
public class FrostBreath extends IceAbility implements SubAbility {
    ...
    private void setCollisions() {
        MasterPowers.collisionManager.addCollision(new Collision(CoreAbility.getAbility("FrostBreath"), CoreAbility.getAbility("AirShield"), true, false));
        MasterPowers.collisionManager.addCollision(new Collision(CoreAbility.getAbility("FrostBreath"), CoreAbility.getAbility("FireShield"), true, true));
    }
