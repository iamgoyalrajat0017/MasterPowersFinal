...
public class AttributeModification {
    ...
    public static final NamespacedKey DAY_FACTOR = new NamespacedKey(MasterPowers.plugin, "DAY_FACTOR");
    public static final NamespacedKey NIGHT_FACTOR = new NamespacedKey(MasterPowers.plugin, "NIGHT_FACTOR");
    public static final NamespacedKey FULL_MOON_FACTOR = new NamespacedKey(MasterPowers.plugin, "FULL_MOON"); //For RPG
    public static final NamespacedKey SOZINS_COMET_FACTOR = new NamespacedKey(MasterPowers.plugin, "SOZINS_COMET"); //For RPG
    public static final NamespacedKey AVATAR_STATE_FACTOR = new NamespacedKey(MasterPowers.plugin, "AVATAR_STATE");
    public static final NamespacedKey BLUE_FIRE_DAMAGE = new NamespacedKey(MasterPowers.plugin, "BLUE_FIRE_DAMAGE");
    public static final NamespacedKey BLUE_FIRE_RANGE = new NamespacedKey(MasterPowers.plugin, "BLUE_FIRE_RANGE");
    public static final NamespacedKey BLUE_FIRE_COOLDOWN = new NamespacedKey(MasterPowers.plugin, "BLUE_FIRE_COOLDOWN");
