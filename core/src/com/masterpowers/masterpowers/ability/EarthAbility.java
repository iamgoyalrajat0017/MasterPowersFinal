...
import com.masterpowers.masterpowers.util.Information;
...
public abstract class EarthAbility extends ElementalAbility {
	 ...
	 * {@link BlockSource#getEarthSourceBlock(Player, double, com.masterpowers.masterpowers.util.ClickType)}
	 *
	 ...
	 * source selection saves the user's previous source for future use.
	 * {@link BlockSource#getLavaSourceBlock(Player, double, com.masterpowers.masterpowers.util.ClickType)}
	 *
	 * @param range the maximum block selection range.
	...
	public static void playEarthbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Earth.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Earth.EarthSound.Sound' is not valid.");
			} finally {
	...
	public static void playMetalbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Earth.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Earth.MetalSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playMudbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Earth.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Earth.MudSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playSandbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Earth.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Earth.SandSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playLavabendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Earth.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Earth.LavaSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
