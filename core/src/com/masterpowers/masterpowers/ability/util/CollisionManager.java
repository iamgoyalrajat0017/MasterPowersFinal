...
import com.masterpowers.masterpowers.event.AbilityCollisionEvent;
 ...
 * MasterPowers.getCollisionInitializer().addCollision(myCoreAbility)
 * MasterPowers.getCollisionInitializer().addSmallAbility(myCoreAbility)
 * <p>
...
public class CollisionManager {
	...
	public void startCollisionDetection() {
		...
		this.detectionRunnable.runTaskTimer(MasterPowers.plugin, 0L, this.detectionDelay);
	}
