...
import com.masterpowers.masterpowers.event.AbilityLoadEvent;
...
public class AbilityLoader<T> {
	...
	public AbilityLoader(final JavaPlugin plugin, final String packageBase) {
		...
		if (plugin == null || this.loader == null) {
			MasterPowers.log.severe("Could not find classloader! Will not load abilities from " + packageBase);
			return;
		}
