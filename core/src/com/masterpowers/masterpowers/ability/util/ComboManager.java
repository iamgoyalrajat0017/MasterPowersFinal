...
import com.masterpowers.masterpowers.earthbending.combo.EarthDomeOthers;
import com.masterpowers.masterpowers.util.ClickType;
import com.masterpowers.masterpowers.util.ReflectionHandler;
...
public class ComboManager {
	...
	public ComboManager() {
		...
		Bukkit.getScheduler().runTaskLater(MasterPowers.plugin, ComboManager::registerCombos, 1L);
		startCleanupTask();
	}
	...
	public static void addComboAbility(final Player player, final ClickType type) {
		...
		}.runTaskLater(MasterPowers.plugin, 1L);
	}
	...
	public static void startCleanupTask() {
		...
		}.runTaskTimer(MasterPowers.plugin, 0, CLEANUP_DELAY);
	}
