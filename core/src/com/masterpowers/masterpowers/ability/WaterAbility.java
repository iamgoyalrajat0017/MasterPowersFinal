...
public abstract class WaterAbility extends ElementalAbility {
	...
	public static Map<Material, Material> getWaterTransformableBlocks() {
		...
		for (String block : transformableBlocks) {
			...
			if (split.length != 2) {
				MasterPowers.log.warning("Invalid TransformableBlock: " + block);
				continue;
			}
	...
	public static void playIcebendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Water.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Water.IceSound.Sound' is not valid.");
			} finally {
	...
	public static void playMudbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Water.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Water.MudSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playPlantbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Water.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Water.PlantSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playWaterbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Water.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Water.WaterSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
