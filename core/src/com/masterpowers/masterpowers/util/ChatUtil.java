...
public class ChatUtil {
    ...
    /**
     * Send a message prefixed with the MasterPowers branding to the provided receiver
    ...
    public static void sendBrandingMessage(final CommandSender receiver, final BaseComponent message) {
        ...
        final String main = color(ConfigManager.languageConfig.get().getString("Chat.Branding.ChatPrefix.Main", "MasterPowers"));
        ...
        if (!(receiver instanceof Player)) {
            ...
            final String hover = multiline(color + ConfigManager.languageConfig.get().getString("Chat.Branding.ChatPrefix.Hover", color + "Bending brought to you by MasterPowers | Fork Roku!\n" + color + "Click for more info."));
            final String click = ConfigManager.languageConfig.get().getString("Chat.Branding.ChatPrefix.Click", "https://www.masterpowers.com");
            if (!hover.equals(""))
