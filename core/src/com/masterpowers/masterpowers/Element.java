...
import com.masterpowers.masterpowers.util.Experimental;
...
public class Element {
	...
	public Element(final String name) {
		this(name, ElementType.BENDING, MasterPowers.plugin);
	}
	...
	public Element(final String name, final ElementType type) {
		this(name, type, MasterPowers.plugin);
	}
	...
	public ChatColor getColor() {
		if (this.color == null) {
			FileConfiguration config = this.plugin == MasterPowers.plugin ? ConfigManager.languageConfig.get() : this.plugin.getConfig();
			...
			try {
				...
				MasterPowers.log.warning("Failed to parse color for " + this.name + " with value: " + value + ". Defaulting to white.");
				e.printStackTrace();
	...
	public ChatColor getSubColor() {
		...
		try {
			...
			MasterPowers.log.warning("Failed to parse sub color for " + this.name + " with value: " + value + ". Defaulting to white.");
			e.printStackTrace();
	...
	public static class SubElement extends Element {
		...
		public SubElement(final String name, final Element parentElement) {
			this(name, parentElement, ElementType.BENDING, MasterPowers.plugin);
		}
		...
		public SubElement(final String name, final Element parentElement, final ElementType type) {
			this(name, parentElement, type, MasterPowers.plugin);
		}
	...
	public static class MultiSubElement extends SubElement {
		...
		public MultiSubElement(String name, ElementType type, Element... parentElements) {
			this(name, type, MasterPowers.plugin, parentElements);
		}
