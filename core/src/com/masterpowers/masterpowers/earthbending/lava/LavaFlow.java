package com.masterpowers.masterpowers.earthbending.lava;
...
import com.masterpowers.masterpowers.ability.LavaAbility;
...
public class LavaFlow extends LavaAbility {
	...
	public void removeOnDelay() {
		...
		br.runTaskLater(MasterPowers.plugin, (long) (this.shiftRemoveDelay / 1000.0 * 20.0));
		this.tasks.add(br);
	}
	...
	public void removeSlowly() {
		...
		for (int i = this.affectedBlocks.size() - 1; i > -1; i--) {
			...
			}.runTaskLater(MasterPowers.plugin, (long) (i / this.shiftRemoveSpeed));
		}
