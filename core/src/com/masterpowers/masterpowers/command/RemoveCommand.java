			...
			if (e == null) { //The first argument must be a playername instead
				...
				if (e instanceof SubElement) { //If it's a subelement
					if (senderBPlayer.hasElement(e)) {
						...
						Bukkit.getServer().getPluginManager().callEvent(new PlayerChangeSubElementEvent(sender, player, (SubElement) e, com.masterpowers.masterpowers.event.PlayerChangeSubElementEvent.Result.REMOVE));
					} else {
