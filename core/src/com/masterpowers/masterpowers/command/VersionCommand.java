...
public class VersionCommand extends PKCommand {
	...
	public void execute(final CommandSender sender, final List<String> args) {
		...
		sender.sendMessage(ChatColor.GOLD + "\u2726 MasterPowers " + ChatColor.GRAY + "- " + ChatColor.AQUA + "Night SMP Edition " + ChatColor.GOLD + "\u2726");
		sender.sendMessage(ChatColor.GREEN + "Core Version: " + ChatColor.RED + MasterPowers.plugin.getDescription().getVersion());
		...
		sender.sendMessage(ChatColor.GREEN + "Learn More: " + ChatColor.RED + "http://masterpowers.com");
	}
