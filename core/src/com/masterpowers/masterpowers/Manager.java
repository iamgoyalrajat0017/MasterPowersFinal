...
public abstract class Manager implements Listener {
	 ...
	 *
	 * @return {@link MasterPowers} plugin instance
	 */
	protected MasterPowers getPlugin() {
		return JavaPlugin.getPlugin(MasterPowers.class);
	}
	...
	public final void activate() {
		Bukkit.getPluginManager().registerEvents(this, MasterPowers.plugin);
		this.onActivate();
	}
