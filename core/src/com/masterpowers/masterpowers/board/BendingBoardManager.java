...
public final class BendingBoardManager {
		...
		if (ConfigManager.languageConfig.get().contains("Board.Extras")) {
			...
			for (String key : section.getKeys(false)) {
				try {
					...
					MasterPowers.plugin.getLogger().warning("Couldn't parse color from 'Board.Extras." + key + "', using white.");
	...
	public static void loadDisabledPlayers() {
		Bukkit.getScheduler().runTaskAsynchronously(MasterPowers.plugin, () -> {
